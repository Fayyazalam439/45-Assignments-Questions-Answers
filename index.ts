...
let addition1: number = 5;
let addition2: number = 3;
console.log("5 + 3 =", addition1 + addition2);//8

let subtraction1: number = 12;
let subtraction2: number = 4;
console.log("12 - 4 =", subtraction1 - subtraction2);//8

let multiplication1: number = 2;
let multiplication2: number = 4;
console.log("2 * 4 =", multiplication1 * multiplication2);//8

let division1: number = 16;
let division2: number = 2;
...
let message1: string = `"My favourite number is ${myNumber}"`
...
//Create type object my-info & data type mention string & number.
type My_Info = {  
    name: string;
    cnic: string;
    email: string;
...
let friendsNames: string[] = ["Hassam","Amir","Moin"]
...
let friendsNames5: string[] = ["Hassam", "Amir", "Moin"];
...
let GuestList: string[] = ["Sami","Amir","Naseer"];
...
let GuestList1: string[] =["Sami","Amir","Naseer"];
...
let visitPlaces: string[] = ["Paris","Turkey","Kahsmir","Switzerland","London"]
...
let DinnerGuest: string[] = ["Sami","Amir","Naseer"];
...
//Guest list count...
let lengthGuest: number = DinnerGuest.length;
...
let countriesName: string[] = ["Pakistan", "Turkey", "Iran", "Dubai","England"]
...
let errorArray: string[] = ["saqib","Ali","Hamza"]
...
// Test whether an item is in a array
let fruits: string[] = ["apple","banana","mango","graps","orange"];
...
//2nd Version...
let alienColor1: string|number = "Yellow";
...
let userNames: string[] = ["saqib","Hassam","Amir","Admin","Ali"]
...
let userNames1: string[] = ["saqib","Hassam","Amir","Admin","Ali"];
...
let currentUsers: string[] = ["Hassam","Saqib","Sami","Amir","Moin","Ali"];
let new_users: string[] = ["salman","Saima","naseer","Amir","ali","junaid"];
...
let pizza: string[] = ["Tikka","Fagita","Malai Boti","BBQ"];
...
function make_shirt(size: string, shirtMessage: string){
...
let magicians_names: string[] = ["Umer","Ubaid","Sajad","Virat"];
...
let magicians_names1: string[] = ["Umer","Ubaid","Sajad","Virat"];
...
let magicians_names2: string[] = ["Umer","Ubaid","Sajad","Virat"];
...
function store_car_info(manufacturer: string, model: string, ...options: { [key: string]: string }[]) {
    let car = {
        manufacturer,
        model,
